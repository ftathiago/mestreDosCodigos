program OMestreDosCodigosTeste;
...
uses
  ...
  OMestreDosCodigos.Teste.Cliente in 'OMestreDosCodigos.Teste.Cliente.pas',
  OMestreDosCodigos.Teste.Cliente.ListaArrayDinamico in 'OMestreDosCodigos.Teste.Cliente.ListaArrayDinamico.pas',
